...
export async function PATCH(
  ...
  try {
    ...
    // Pending Review, or Rejected — requireArtist() above already verified
    // the caller's session token maps to this artist, so this just stops an
    // approved/live release from being silently rewritten.
